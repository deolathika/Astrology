...
class AIContentService {
  ...
  /// Sri Lankan quotes with cultural context
  static List<String> _getSriLankanQuotes(String sign) {
    final quotes = {
      'Aries': [
        'අද ඔබේ ධෛර්යය ඔබේ ගමනේ මගපෙන්වන්න. නව අභියෝග ගෙන එන අවස්ථාවලදී ඔබේ අභ්‍යන්තර බලය භාවිතා කරන්න.',
        'මේෂ රාශියේ බලය අද ඔබේ අතේ ඇත. නායකත්වය ගෙන ඔබේ අභිලාෂයන් සාක්ෂාත් කර ගන්න.',
        'අද ඔබේ උද්යෝගය අන්‍යයන්ට ද ආශ්වාදයක් වේවා. ඔබේ ධෛර්යය අන්‍යයන්ට ද බලය ලබා දෙන්න.',
      ],
      'Taurus': [
