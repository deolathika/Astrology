...
import { 
  ...
  Heart, Moon, Star, Brain, Target, Calendar,
  ...
  FileVideo, FileAudio, FilePdf, FileWord,
  FileExcel, FilePowerpoint, FileArchive, FileCode,
  FileCsv, FileJson, FileXml, FileHtml, FileCss,
  FileJs, FileTs, FileJsx, FileTsx, FileVue,
  FileReact, FileAngular, FileSvelte, FilePhp,
  FilePython, FileJava, FileCpp, FileC, FileCsharp,
  FileGo, FileRust, FileSwift, FileKotlin, FileDart,
  FileFlutter, FileReactNative, FileIonic, FileCordova,
  FilePhonegap, FileXamarin, FileUnity, FileUnreal,
  FileGodot, FileBlender, FileMaya, FileMax,
  FileCinema4d, FileAfterEffects, FilePremiere,
  FileFinalCut, FileDaVinci, FileOBS, FileStreamlabs,
  FileXsplit, FileWirecast, FileVmix, FileOBSStudio,
  FileStreamElements, FileRestream, FileTwitch,
  FileYouTube, FileFacebook, FileInstagram, FileTwitter,
  FileTikTok, FileLinkedIn, FileSnapchat, FilePinterest,
  FileReddit, FileDiscord, FileSlack, FileTeams,
  FileZoom, FileSkype, FileWhatsApp, FileTelegram,
  FileSignal, FileViber, FileWeChat, FileLine,
  FileKakao, FileZalo, FileVK, FileOdnoklassniki,
  FileYandex, FileBaidu, FileQQ, FileWeibo, FileRenren,
  FileKaixin, FileDouban, FileTieba, FileZhihu,
  FileBilibili, FileAcFun, FileNiconico, FileVimeo,
  FileDailymotion, FileDTube, FileLBRY, FileOdysee,
  FileRumble, FileBitChute, FileGab, FileParler,
  FileTruth, FileGettr, FileMastodon, FileBluesky,
  FileThreads, FileSpaces, FileClubhouse
} from 'lucide-react'
